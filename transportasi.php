...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-right">
      ...
      <div class="container p-3 my-3 bg-primary text-white">
        <h2>Trayek Angkot Probolinggo </h2>
      </div>

      <img src="trayek_angkot.jpg" width="50%" height="50%" style="display: block; margin: auto;">

<ul class="pagination">
         <li class="page-item"><a class="page-link" href="index.html">Home</a></li>
         <li class="page-item"><a class="page-link" href="pariwisata.php">1</a></li>
         <li class="page-item active"><a class= "page-link" href="transportasi.php">2</a></li>
      </ul>
